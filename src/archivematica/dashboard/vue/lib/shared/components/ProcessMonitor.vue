...
import { useProcessingMonitor } from '@/shared/composables'
import type { MonitorUnitType } from '@/shared/composables'
import type { MonitorConfig } from '@/shared/composables'
...
<template>
  ...
  >
    <div id="sip-header">
      <slot
        name="header"
        :remove-all="requestRemoveAllUnits"
      />
    </div>
    <div id="sip-body">
      <p
