...
const TreeViewStub = defineComponent({
  ...
  setup(props, { slots, expose }) {
    expose({ focusTree: focusTreeMock })
    return () =>
...
describe('AipBrowser', () => {
  ...
  it('loads the directory contents and focuses the tree', async () => {
    ...
    expect(focusTreeMock).toHaveBeenCalledTimes(1)
  })
  ...
  it('retries loading after a failure', async () => {
    ...
    expect(wrapper.find('[data-testid="tree-view"]').exists()).toBe(true)
  })
